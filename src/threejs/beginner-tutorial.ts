// https://github.com/WaelYasmina/threetutorial/blob/main/src/js/scripts.js
...
const vertexShader = document.querySelector('#vertex-shader')! as HTMLScriptElement;
const fragmentShader = document.querySelector('#vertex-shader')! as HTMLScriptElement;
